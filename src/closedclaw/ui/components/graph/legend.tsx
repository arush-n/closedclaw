...
export const Legend = memo<LegendProps>(function Legend({
  ...
  return (
    <div className="absolute top-14 right-4 z-10 min-w-[220px] max-w-[260px]">
      <motion.div
        layout
            ...
            >
              <div className="px-4 pb-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1 text-xs">
                      <div className="flex items-center gap-2">
                        <span className="h-1.5 w-1.5 rounded-full bg-slate-200/90" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[rgba(241,245,249,0.95)]" />
                      <span className="text-slate-200">Document</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2.5 h-2.5 rounded-full bg-[rgba(16,185,129,0.92)]" />
                      <span className="text-slate-200">Memory (latest)</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[rgba(148,163,184,0.8)]" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[rgba(248,113,113,0.95)]" />
                      <span className="text-slate-200">Forgotten</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[rgba(250,204,21,0.95)]" />
                      <span className="text-slate-200">Expiring soon</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[rgba(16,185,129,0.95)]" />
